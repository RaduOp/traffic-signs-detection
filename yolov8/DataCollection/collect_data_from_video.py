...
def process_video(path_to_video: str, save_location: str, frame_skip_factor: int = 3,
                  show_output: bool = True, base_file_name='auto_collected') -> None:
...
if __name__ == '__main__':
    ...
    whitelisted_classes = [class_names.index(key) for key, item in number_of_occurrences.items() if
                           item < 100]
    ...
    process_video("../auxiliary_files/rendered.mp4", frame_skip_factor=3,
